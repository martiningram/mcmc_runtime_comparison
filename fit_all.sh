...
for start_year in 2020 2019 2015 2010 2000 1990 1980 1968; do
    ...
    echo "PyMC JAX CPU vectorized" && python fit_pymc_jax.py $start_year cpu vectorized "$target_dir" $random_seed
    echo "PyMC BlackJAX CPU" && python fit_pymc_blackjax.py $start_year cpu "$target_dir" $random_seed
